...
@shared_task(name="Import from Trackii")
def import_trackii(file, user_id, mode):
    """Celery task for importing media data from Trackii."""
    return import_media(trackii.importer, file, user_id, mode)
